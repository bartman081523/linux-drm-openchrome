...
pkgbase=linux-drm-openchrome
pkgver=6.8.r1253665.ac5e7e1ca4d4
pkgrel=1
pkgdesc='Linux kernel with bleeding-edge GPU drivers'
url=https://anongit.freedesktop.org/git/openchrome/drm-openchrome
_product="${pkgbase%-git}"
_branch=drm-next-6.9
arch=(x86_64)
